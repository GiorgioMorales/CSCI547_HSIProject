from keras.layers import Conv3D, SeparableConv2D, Dense, Reshape, Flatten, Dropout
...
def weedann(img_shape=(256, 256, 50, 1), classes=2):
    ...
    fc = Dense(units=500, activation='relu', kernel_regularizer=regularizers.l2(0.005))(
